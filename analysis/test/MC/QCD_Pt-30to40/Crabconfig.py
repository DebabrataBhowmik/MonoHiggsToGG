...
config.General.requestName   = 'QCD_Pt-30to40_newID_rightPU'
config.General.transferLogs = True
config.JobType.pluginName  = 'Analysis'

config.JobType.inputFiles  = ['input_files/transformation_Moriond17_AfterPreApr_v1.root', 'input_files/pu_Weights_QCD_Pt30to40.root', 'input_files/Run2017_17Nov2017_v1_ele_smearings.dat', 'input_files/Run2017_17Nov2017_v1_ele_scales.dat']
...
config.Data.inputDataset = '/QCD_Pt-30to40_DoubleEMEnriched_MGG-80toInf_TuneCP5_13TeV_Pythia8/sethzenz-RunIIFall17-3_1_0-3_1_0-v0-RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1-dfb4aebb0a34a36b04b8bd8eb2ddfe46/USER'
...
config.Data.outLFNDirBase = '/store/user/dbhowmik/MHgg/Bkg/newID_rightPUweight/BkgQCD_Pt-30to40_2017MC'
